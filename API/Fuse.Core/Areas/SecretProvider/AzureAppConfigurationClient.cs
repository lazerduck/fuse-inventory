...
public class AzureAppConfigurationClient : IAzureAppConfigurationClient
{
    ...
    public async Task<Result<AppConfigurationEntry?>> GetKeyValueAsync(Models.SecretProvider provider, string key, string? label = null)
    {
        try
        {
            var client = await GetClientAsync(provider);
    ...
    public async Task<Result<AppConfigurationEntry>> SetKeyValueAsync(Models.SecretProvider provider, string key, string? label, string value, string? contentType)
    {
        try
        {
            var client = await GetClientAsync(provider);
    ...
    private async Task<IAppConfigurationClient> GetClientAsync(Models.SecretProvider provider)
    {
