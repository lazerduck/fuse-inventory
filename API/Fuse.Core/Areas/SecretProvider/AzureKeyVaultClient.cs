...
public class AzureKeyVaultClient : IAzureKeyVaultClient
{
    ...
    public async Task<Result> CheckSecretExistsAsync(Models.SecretProvider provider, string secretName)
    {
        try
        {
    ...
    public async Task<Result> CreateSecretAsync(Models.SecretProvider provider, string secretName, string secretValue)
    {
        try
        {
            var client = await GetClientAsync(provider);
    ...
    public async Task<Result> RotateSecretAsync(Models.SecretProvider provider, string secretName, string newSecretValue)
    {
        try
        {
            var client = await GetClientAsync(provider);
    ...
    public async Task<Result<string>> ReadSecretAsync(Models.SecretProvider provider, string secretName, string? version = null)
    {
        try
        {
            var client = await GetClientAsync(provider);
    ...
    public async Task<Result<IReadOnlyList<SecretMetadata>>> ListSecretsAsync(Models.SecretProvider provider)
    {
        try
        {
            var client = await GetClientAsync(provider);
    ...
    private async Task<IKeyVaultSecretClient> GetClientAsync(Models.SecretProvider provider)
    {
    ...
    private async Task<SecretProviderCredentials?> ResolveProviderCredentialsAsync(Models.SecretProvider provider)
    {
